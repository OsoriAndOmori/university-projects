...
///////////////////////////////////4
		...
		$qry2 = mysql_query("Select salt from $this->tablename where username='$username'",$this->connection); 
        $row = mysql_fetch_assoc($qry2);
        $user_rec['salt'] = $row['salt'];
		...
		$next_salt=$this->Mycrypt();

		

        $qry_new_pw = "Update $this->tablename Set password='".crypt($tmp,$next_salt)."' Where  username='$username'";
        ...
        $qry_nextnum = "Update $this->tablename Set number='".(int)$row_num['number']."' Where  username='$username'"; ///////////////////////6
...
1*/
    ...
    function SendUserConfirmationEmail(&$formvars)
    {
        ...
        if(!$mailer->Send())
        {
            $this->HandleError("Registration Complete !");
            return false;
        }
        return true;
    }
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->tablename.'( 
                ...
                "' . crypt($pass,$formvars['salt']) . '",
                "' . $this->SanitizeForSQL($formvars['salt']).'",
                "' . $this->SanitizeForSQL($formvars['number']).'"
                )';      
